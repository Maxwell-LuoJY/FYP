...
def pacmap_visualization(cluster_indices, x, y, save_dir):
    # Import PaCMAP with fallback
    try:
        from pacmap import PaCMAP
    except ImportError:
        print("Warning: PaCMAP not available, skipping PaCMAP visualization")
        return
    print('Using PacMAP')
...
def umap_visualization(cluster_indices, x, y, save_dir):
    ...
    try:
        ...
        print("Warning: UMAP not available, skipping UMAP visualization")
        return
